...
public class NfeController {
    ...
    public ResponseEntity<?> process(@RequestBody Map<String, Object> payload) {
        String numNotaLog = "0";
        try {
            if (payload == null || payload.get("company") == null) return ResponseEntity.badRequest().body(Map.of("erro", "Payload incompleto"));
            ...
            // ITENS (CORREÇÃO ABSOLUTA USANDO OBJETOS NATIVOS)
            ...
            for (Map<String, Object> itemData : items) {
                ...
                // IMPOSTO VIA OBJETO (SEM XML STRING)
            ...
            // TOTAIS E PAGAMENTO (XML INJECTION REFINADO)
